...
plot(data$Date, (data$Chla_sqrt)^2, cex.lab = 1.5, type = 'n', xlab = "Date", ylab = "Chlorophyll a (ug/L)", xlim = c(as.Date("2013-01-01"), as.Date("2016-12-31")))
...
points(data$Date, (pred1_1316)^2, col = '#fc8d59', type = 'l', lwd = 2)
legend('topleft', c('Observed', 'AR Model'),cex = 1.5,  lty = c(1,1), col = c('black', '#fc8d59'), bty = 'n')
