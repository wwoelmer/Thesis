...
data <- read.csv("model_transformed_chlalog_2013_2016.csv")
...
spear <- cor$r
write.csv(spear, "./correlation matrices/chlalog_1.0m/correlation_matrix_chlalog_2013_2016.csv", row.names = FALSE)
...
# 2013
dataall <- read.csv("model_transformed_chlalog_2013_2016.csv")
...
spear_13 <- cor_13$r
write.csv(spear_13, "./correlation matrices/chlalog_1.0m/correlation_matrix_chlalog_2013.csv", row.names = FALSE)
...
spear_14 <- cor_14$r
write.csv(spear_14, "./correlation matrices/chlalog_1.0m/correlation_matrix_chlalog_2014.csv", row.names = FALSE)
...
spear_15 <- cor_15$r
write.csv(spear_15, "./correlation matrices/chlalog_1.0m/correlation_matrix_chlalog_2015.csv", row.names = FALSE)
...
spear_16 <- cor_16$r
write.csv(spear_16, "./correlation matrices/chlalog_1.0m/correlation_matrix_chlalog_2016.csv", row.names = FALSE)
