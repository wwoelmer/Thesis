...
sites <- read_csv("./Materials for R mapping/nutrient_mapping/04_April/Apr_RCC_ammonium_mapping.csv")
...
c = c + ggtitle('April') + theme(plot.title = element_text(size = 40))


pdf("./Materials for R mapping/nutrient_mapping/04_April/29Apr19_RCC_NH4.pdf", width = 8, height = 6)
c
dev.off()

png("./Materials for R mapping/nutrient_mapping/04_April/29Apr19_RCC_NH4.png", width = 1100, height = 800)
c
dev.off()
