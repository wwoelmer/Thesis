...
sites <- read_csv("./Materials for R mapping/nutrient_mapping/08_August/Aug_RCC_phosphate_mapping.csv")
...
pdf("./Materials for R mapping/nutrient_mapping/08_August/22Aug19_RCC_PO4.pdf", width = 8, height = 6)
c
dev.off()

png("./Materials for R mapping/nutrient_mapping/08_August/22Aug19_RCC_PO4.png", width = 1100, height = 800)
c
dev.off()
