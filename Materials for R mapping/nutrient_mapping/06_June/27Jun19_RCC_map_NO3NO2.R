...
sites <- read_csv("./Materials for R mapping/nutrient_mapping/06_June/Jun_RCC_nitrate_mapping.csv")
...
pdf("./Materials for R mapping/nutrient_mapping/06_June/27Jun19_RCC_NO3NO2.pdf", width = 8, height = 6)
c
dev.off()

png("./Materials for R mapping/nutrient_mapping/06_June/27Jun19_RCC_NO3NO2.png", width = 1100, height = 800)
c
dev.off()
