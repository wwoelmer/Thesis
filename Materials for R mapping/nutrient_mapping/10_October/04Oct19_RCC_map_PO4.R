...
sites <- read_csv("./Materials for R mapping/nutrient_mapping/10_october/Oct_RCC_phosphate_mapping.csv")
...
pdf("./Materials for R mapping/nutrient_mapping/10_october/04Oct19_RCC_PO4.pdf", width = 8, height = 6)
c
dev.off()

png("./Materials for R mapping/nutrient_mapping/10_october/04Oct19_RCC_PO4.png", width = 1100, height = 800)
c
dev.off()
