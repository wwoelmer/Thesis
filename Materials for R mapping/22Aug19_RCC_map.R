...
sites <- read_csv("./Materials for R mapping/Aug_RCC_chla_mapping.csv")
...
b = a +
  ...
  scale_size_continuous(limits=c(0,42),breaks=c(0,10,20,30,42))
...
pdf("./Materials for R mapping/22Aug19_RCC_chla.pdf", width = 8, height = 6)
c
dev.off()

png("./Materials for R mapping/22Aug19_RCC_chla.png", width = 1100, height = 800)
c
dev.off()
