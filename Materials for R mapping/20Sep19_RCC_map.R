...
sites <- read_csv("./Materials for R mapping/Sep_RCC_chla_mapping.csv")
...
pdf("./Materials for R mapping/20Sep19_RCC_chla.pdf", width = 8, height = 6)
c
dev.off()

png("./Materials for R mapping/20Sep19_RCC_chla.png", width = 1100, height = 800)
c
dev.off()
