...
MetData <- read.csv('./Data/MET/FCR_GLM_met_NLDAS2_010113_010118_GMTadjusted.csv', header=T, na.strings=NA) #in begwrkspc
MetData <- read.csv('./Data/MET/FCR_GLM_met_NLDAS2_Dec14_Dec18.csv', header=T, na.strings=NA) #in begwrkspc
...
write.csv(wsrunoff, "./Data/Inflows_Modeling/HydroModeling/overland_runoff_FCR_Dec14_Dec18.csv", row.names = FALSE)
# subset to just 2018 wetland data
wsrunoff_wet <- wsrunoff[wsrunoff$Site=='wetland' & wsrunoff$date>'2017-12-31',]
write.csv(wsrunoff_wet, "./Data/Inflows_Modeling/FCR_inflows/overland_runoff_FCRwetland_2018.csv", row.names = FALSE)
